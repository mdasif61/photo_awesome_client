            ...
            <div className="join join-vertical w-full">
              <div className="collapse collapse-arrow join-item border border-base-300">
                ...
                <div className="collapse-title text-xl font-medium">
                  Q1. What are the key benefits of enrolling in a photography
                  school?
                </div>
                <div className="collapse-content">
                  <p>
                    Comprehensive education, hands-on experience, expert
              ...
              <div className="collapse collapse-arrow join-item border border-base-300">
                ...
                <div className="collapse-title text-xl font-medium">
                  Q2. What sets your photography school apart from others in the
                  industry?
                </div>
                <div className="collapse-content">
                  <p>
                    Specialized focus, industry-experienced faculty, diverse
              ...
              <div className="collapse collapse-arrow join-item border border-base-300">
                <input type="radio" name="my-accordion-4" />
                <div className="collapse-title text-xl font-medium">
                  Q3. Do I need any prior photography experience to join your
                  school?
                </div>
                <div className="collapse-content">
